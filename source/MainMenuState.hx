...
{
	public static var gabEngineVersion:String = '0.6.3'; //This is also used for Discord RPC
    ...
    Paths.clearStoredMemory();
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 44, 0, "Gabz Engine v" + gabEngineVersion, 12);
